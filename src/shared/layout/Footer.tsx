...
const Footer = () => {
  ...
  return (
    <footer className="bg-gradient-to-b from-neutral-900 to-neutral-800 text-neutral-300 font-sans">
      <Container>
        <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
          <div className="md:col-span-12 grid grid-cols-1 gap-8 py-12 md:grid-cols-3">
            ...
            <div className="space-y-4">
              <h4 className="text-lg font-semibold text-neutral-50">Navegação</h4>
            ...
            <div className="space-y-4">
              <h4 className="text-lg font-semibold text-neutral-50">Contato</h4>
      ...
      <div className="border-t border-neutral-700 py-8 text-center text-neutral-400 font-sans">
